package prjava13.fernandez; 
import java.awt.*;        // using AWT containers and components 
import java.awt.event.*;  // using AWT events and listener interfaces 
import java.io.*;
 
// An AWT GUI program inherits the top-level container java.awt.Frame 
public class Prjava13fernandez extends Frame 
   ...
   public Prjava13fernandez () { 
      ...
      setTitle("nova finestra prjava13-fernandez");  // "this" Frame sets title 
   ...
   public static void main(String[] args) { 
      new Prjava13fernandez();  // Let the construct do the job 
   } 
